...
from mapitio_prn.constants import END_OF_STUDY_ACTION
...
class AeFollowupAction(ActionWithNotification):
    ...
    reference_model = "mapitio_ae.aefollowup"
    related_reference_model = "mapitio_ae.aeinitial"
    related_reference_fk_attr = "ae_initial"
    create_by_user = False
    show_link_to_changelist = True
    admin_site_name = "mapitio_ae_admin"
...
class AeInitialAction(ActionWithNotification):
    ...
    parent_action_names = []
    reference_model = "mapitio_ae.aeinitial"
    show_link_to_changelist = True
...
class AeSusarAction(ActionWithNotification):
    ...
    reference_model = "mapitio_ae.aesusar"
    related_reference_model = "mapitio_ae.aeinitial"
    related_reference_fk_attr = "ae_initial"
    create_by_user = False
    show_link_to_changelist = True
...
class AeTmgAction(ActionWithNotification):
    ...
    reference_model = "mapitio_ae.aetmg"
    related_reference_model = "mapitio_ae.aeinitial"
    related_reference_fk_attr = "ae_initial"
    create_by_user = False
    color_style = "info"
...
class DeathReportAction(ActionWithNotification):
    ...
    reference_model = "mapitio_ae.deathreport"
    parent_action_names = [AE_INITIAL_ACTION, AE_FOLLOWUP_ACTION]
    show_link_to_changelist = True
    show_link_to_add = True
    admin_site_name = "mapitio_ae_admin"
...
class DeathReportTmgAction(ActionWithNotification):
    ...
    reference_model = "mapitio_ae.deathreporttmg"
    related_reference_model = "mapitio_ae.deathreport"
