...
from mapitio_sites import mapitio_sites
...
if TOWN:
    SITE_ID = get_site_id(TOWN, sites=mapitio_sites)
else:
...
INSTALLED_APPS = [
    ...
    "mapitio_sites.apps.AppConfig",
    "mapitio_edc.apps.EdcAppointmentAppConfig",
    "mapitio_edc.apps.EdcDeviceAppConfig",
    "mapitio_edc.apps.EdcIdentifierAppConfig",
    "mapitio_edc.apps.EdcMetadataAppConfig",
    "mapitio_edc.apps.EdcProtocolAppConfig",
    "mapitio_edc.apps.EdcVisitTrackingAppConfig",
    "mapitio_edc.apps.EdcFacilityAppConfig",
