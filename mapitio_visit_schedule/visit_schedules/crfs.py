...
crfs_d1 = FormsCollection(
    ...
    Crf(show_order=150, model="mapitio_subject.ncdfollowup"),
    Crf(show_order=160, model="mapitio_subject.biomedicalfollowup"),
    Crf(show_order=170, model="mapitio_subject.complications"),
    Crf(show_order=180, model="mapitio_subject.investigations"),
    name="day1",
)
