    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="+",
                        to="mapitio_prn.UnblindingReviewerUser",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="+",
                        to="mapitio_prn.UnblindingRequestorUser",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="+",
                        to="mapitio_lists.OffstudyReasons",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="mapitio_prn_subject_f827bc_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="mapitio_prn_subject_056ac1_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="mapitio_prn_subject_264191_idx",
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="mapitio_prn_subject_af6962_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="mapitio_prn_id_117cc0_idx",
            ),
        ),
    ]
